...
import com.myproject.view.blur.Blur;
import com.myproject.view.blur.ScrollableImageView;
import com.myproject.view.blur.ImageUtils;

public class AtyBlurEffect extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.aty_blur);
		...
		if (!blurredImage.exists()) {
			...
			new Thread(new Runnable() {
				...
				public void run() {
					...
					Bitmap newImg = Blur.fastblur(AtyBlurEffect.this, image, 12);
